...
class AnomalibDetection(ctk.CTk):
    ...
    #MAIN TAB
        ...
        label_component1 = ctk.CTkLabel(canvas1_panel, text="Wconn 1", font=ctk.CTkFont(size=12, weight="bold")).grid(row=0, column=0, pady=(5,0), padx=10, sticky="nsew")    
        ...
        label_component2 = ctk.CTkLabel(canvas2_panel, text="Cool 1", font=ctk.CTkFont(size=12, weight="bold")).grid(row=0, column=0, pady=(5,0), padx=10, sticky="nsew") 
        ...
        label_component3 = ctk.CTkLabel(canvas3_panel, text="Cool 2", font=ctk.CTkFont(size=12, weight="bold")).grid(row=0, column=0, pady=(5,0), padx=10, sticky="nsew") 
        ...
        self.scorebox6 = ctk.CTkTextbox(panel_score4, width=150, height=40, fg_color=self.theme["surface"], corner_radius=15, border_width=2, border_color=self.theme["border"],  )
        ...
        self.resbox6 = ctk.CTkTextbox(panel_score4, width=150, height=40, fg_color=self.theme["surface"], corner_radius=15, border_width=2, border_color=self.theme["border"], )
        ...
        self.scorebox7 = ctk.CTkTextbox(panel_score5, width=150, height=40, fg_color=self.theme["surface"], corner_radius=15, border_width=2, border_color=self.theme["border"],  )
        ...
        self.resbox7 = ctk.CTkTextbox(panel_score5, width=150, height=40, fg_color=self.theme["surface"], corner_radius=15, border_width=2, border_color=self.theme["border"],  )
        ...
        self.scorebox8 = ctk.CTkTextbox(panel_score6, width=150, height=40, fg_color=self.theme["surface"], corner_radius=15, border_width=2, border_color=self.theme["border"],  )
        ...
        self.resbox8 = ctk.CTkTextbox(panel_score6, width=150, height=40, fg_color=self.theme["surface"], corner_radius=15, border_width=2, border_color=self.theme["border"],  )
        self.resbox8.grid(row=4, column=0, padx=10, pady=10, sticky="nsew")

        label_ISNtext = ctk.CTkLabel(right_panel4, text="ISN:", font=ctk.CTkFont(size=16, weight="bold")).grid(row=0, column=0, pady=10, padx=10)
        self.label_ISN = ctk.CTkLabel(right_panel4, text="     ", font=("Arial", 20))
        ...
        label_overall = ctk.CTkLabel(right_panel4, text="Overall Result:", font=ctk.CTkFont(size=16, weight="bold")).grid(row=3, column=0, pady=10, padx=10)
